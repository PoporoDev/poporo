...
# Create poporo user
RUN adduser --system --group --disabled-password poporo && \
	mkdir -p /wallet /home/poporo/.bitpoporo && \
	chown -R poporo:poporo /home/poporo/.bitpoporo && \
	chown -R poporo:poporo /wallet

# Contains the blockchain
VOLUME /home/poporo/.bitpoporo
...
# switch to user poporo
USER poporo

ENTRYPOINT ["poporod", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18081", "--non-interactive", "--confirm-external-bind"]
