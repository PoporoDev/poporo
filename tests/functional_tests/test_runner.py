...
BASE_SCRIPTS= [
    ...
    # 'feature_segwit.py', #failed for ERROR: ConnectBlock: CheckQueue failed
    ...
    'p2p_invalid_tx.py',
    # 'feature_versionbits_warning.py', #failed
    ...
    # 'feature_dersig.py', #failed for more than 1K blocks
    # 'feature_cltv.py',#failed for more than 1K blocks
    'rpc_uptime.py',
